...
document.addEventListener("DOMContentLoaded", () => {
 ...
 document.addEventListener("DOMContentLoaded", () => {
    ...
    const galleryItems = [
        { img: "IMG/2024(1).jpg", title: "Orientation Day", desc: "Welcoming the new batch of procurement leaders." },
        { img: "IMG/2023(6).jpeg", title: "Networking Event", desc: "Students connecting with industry giants." },
        { img: "IMG/2024(1).jpg", title: "Workshop 101", desc: "Hands-on training in supply chain logistics." },
        { img: "IMG/2024(1).jpg", title: "Annual Summit", desc: "Celebrating excellence in our department." },
        { img: "IMG/2022(1).jpeg", title: "Guest Lecture", desc: "Insights from the CEO of Logistics Co." },
        { img: "IMG/2024(1).jpg", title: "Study Tour", desc: "Visiting the port authority for real experience." },
        { img: "IMG/2023(4).jpeg", title: "Graduation", desc: "Our members stepping into the professional world." },
        { img: "IMG/2024(1).jpg", title: "Charity Drive", desc: "Giving back to the community together." },
        { img: "IMG/2024(11).jpg", title: "Tech Seminar", desc: "Learning about AI in procurement." },
        { img: "IMG/2023(1).jpeg", title: "Team Building", desc: "Strengthening bonds at the retreat." },
        { img: "IMG/2022(1).jpeg", title: "Innovation Award", desc: "Recognizing creative solutions in supply chain." },
        { img: "IMG/2023(3).jpeg", title: "Alumni Meet", desc: "Connecting past and present members." },
        { img: "IMG/2024(5).jpg", title: "Exam Prep", desc: "Group studies for the PSPTB exams." },
        { img: "IMG/2022(4).jpeg", title: "Sports Day", desc: "Healthy competition on the field." },
        { img: "IMG/2024(7).jpg", title: "Internship Fair", desc: "Securing placements for our students." },
        { img: "IMG/2022(3).jpeg", title: "Debate Club", desc: "Discussing ethics in global sourcing." },
        { img: "IMG/2023(5).jpeg", title: "Cultural Night", desc: "Celebrating our diverse backgrounds." },
        { img: "IMG/2022(2).jpeg", title: "Mentorship", desc: "Seniors guiding juniors." },
        { img: "IMG/2022(5).jpeg", title: "Project Demo", desc: "Showcasing final year procurement projects." },
        { img: "IMG/2024(11).jpg", title: "Farewell Party", desc: "Wishing the best to outgoing leaders." },
    ];
